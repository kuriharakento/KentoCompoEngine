...
private:
     ...
     * @return イージングを適用した値（0.0〜1.0、オーバーシュート型は範囲外も可）
     */
     ...
     * @brief バーのサイズを更新
     * 
     * レターボックスの高さとオーバーシュートマージンを考慮してサイズを更新します。
     */
    void UpdateBarSizes();
...
private:
    ...
    float overshootMargin_ = 100.0f; ///< オーバーシュート用の余白（BackやElasticイージングで範囲外に出る分）
